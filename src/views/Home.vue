...
<!--  </div>-->
  ...
  <section id="map" class="map-area">
    ...
    <div class="map-bg bg_cover d-none d-lg-block" style="height: 100%;">
      <img src="../assets/images/map/map-bg.jpg" alt="">
    </div>
  </section>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="copyright text-center">
              <p>Template Designed and Developed by <a href="https://uideck.com" rel="nofollow">UDeck</a></p>
            </div> <!-- copyright -->
          </div>
        </div> <!-- row -->
      </div> <!-- container -->
